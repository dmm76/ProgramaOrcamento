...
public class TelaCliente extends JInternalFrame {
    ...
    public TelaCliente(JDesktopPane desktopPane) {
        ...
        scrollPane.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS); // Barra de rolagem sempre visível
...
//            btnCliRemover.setEnabled(false);
    ...
    private void alterar() {
        ...
        try {
            ...
            if (txtCliName.getText().isEmpty() || txtCliEndereco.getText().isEmpty() || txtCliEmail.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Preencha todos os campos obrigatórios!");
                return;
            }
